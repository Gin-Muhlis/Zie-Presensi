...
checkSession("login_wali kelas"); // !menjalankan fungsi untuk mengecek session
...
<body>
    <div class="sidebar">
        ...
        <div class="body-sidebar">
            ...
            <div class="menu">
                <a href="../agenda/data_agenda.php">Agenda</a>
            </div>
        </div>
    ...
    <div class="container">
        <div class="wrapper">
            ...
            <form action="#" method="POST">
                ...
                <label class="field" id="field-kelas">
                    <span class="label">Kelas</span>
                    <span class="two-point">:</span>
                    <input type="text" name="kelas" id="kelas" autocomplete="off" value="<?= strtoupper($dataUser["kelas"]) ?>">
                </label>
                <label class="field">
